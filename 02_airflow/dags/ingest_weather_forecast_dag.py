...
# Lat & Lon of the location the weather data will be downloaded
...
def extract_temperatures_forecast(local_file_name):
...
with DAG(
    dag_id="ingest_weather_forecast_dg",
    ...
    extract_data_task = PythonOperator(
        ...
        python_callable=extract_temperatures_forecast,
        op_kwargs={
    ...
    # delete files downloaded locally
